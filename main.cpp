	...
	for (int day = 0; day < days.size(); day++) {
	  for (int hour = 0; hour < hours.size(); hour++) {
            ...
            if ((subjects[groups[group]][i1].second.rfind("gra", 0) == 0 && subjects[groups[group]][i2].second.rfind("ver", 0) == 0) ||
              ...
              continue;
            // cuvari prirode i slikanje smeju istovremeno
            if ((subjects[groups[group]][i1].second.rfind("cp", 0) == 0 && subjects[groups[group]][i2].second.rfind("csv", 0) == 0) ||
                (subjects[groups[group]][i1].second.rfind("csv", 0) == 0 && subjects[groups[group]][i2].second.rfind("cp", 0) == 0))
              continue;
            // domacinstvo i slikanje smeju istovremeno
            if ((subjects[groups[group]][i1].second.rfind("dom", 0) == 0 && subjects[groups[group]][i2].second.rfind("csv", 0) == 0) ||
                (subjects[groups[group]][i1].second.rfind("csv", 0) == 0 && subjects[groups[group]][i2].second.rfind("dom", 0) == 0))
              continue;

            // hor i slikanje smeju istovremeno
            if ((subjects[groups[group]][i1].second.rfind("hor", 0) == 0 && subjects[groups[group]][i2].second.rfind("csv", 0) == 0) ||
                (subjects[groups[group]][i1].second.rfind("csv", 0) == 0 && subjects[groups[group]][i2].second.rfind("hor", 0) == 0))
              continue;
            // cuvari prirode i hor smeju istovremeno
            if ((subjects[groups[group]][i1].second.rfind("cp", 0) == 0 && subjects[groups[group]][i2].second.rfind("hor", 0) == 0) ||
                (subjects[groups[group]][i1].second.rfind("hor", 0) == 0 && subjects[groups[group]][i2].second.rfind("cp", 0) == 0))
              continue;
...
void generate_long_stay_conditions() {
  ...
  for (int teacher = 0; teacher < teachers.size(); teacher++) {
	...
	for (int i = 0; i + d - 1 < hours.size(); i++) {
      ...
      if (teachers[teacher] == "stebru" || teachers[teacher] == "trina")
        continue;
...
void parse() {
  ...
  while(getline(cin, line)) {
	...
	cout << line << endl;
      ...
      generate_cardinality_constraints(teachers, k, "_people_");
